...
**Создать новость**
----
Создается новость. Доступ к роуту осуществляется только ключ news в куках, значение которого можно уточнить.
...
**Изменить новость**
----
Изменяется новость. Доступ к роуту осуществляется только ключ news в куках, значение которого можно уточнить.
...
**Удалить новость**
----
Удаляет одну из новостей по id. Доступ к роуту осуществляется только ключ news в куках, значение которого можно уточнить.
